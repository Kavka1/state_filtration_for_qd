...
if __name__ == "__main__":
    main(
        path= '/home/xukang/Project/state_filtration_for_qd/results_for_ensemble/Hopper-missing_leg_1-10/',
        remark='best',
        env_config={
            'env_name': 'Hopper',
            'broken_leg_info': {
        ...
        csv_path='/home/xukang/Project/state_filtration_for_qd/statistic/Hopper_broken_leg_0.5_0.5-10.csv'
    )