...
if __name__ == '__main__':
    main(
        path='/home/xukang/Project/state_filtration_for_qd/results_for_ensemble/HalfCheetah-missing_coord_2_3-10/',
        remark='best',
        noise_index=[2,3,4,5,6,7],
        csv_path='/home/xukang/Project/state_filtration_for_qd/statistic/HalfCheetah_coord_2_3-10.csv'
    )