...
class SMERL_SAC(object):
    def __init__(self, config: Dict) -> None:
        super(SMERL_SAC, self).__init__()
    ...
    def train(self, buffer: Buffer, episode_return: float) -> Dict:
        ...
        if episode_return > (1 - self.epsilon) * self.return_default:
            r   =   r + self.alpha * bonus
            use_bonus = 1
        else:
            use_bonus = 0
