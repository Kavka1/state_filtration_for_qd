...
from state_filtration_for_qd.baseline.smerl.agent_ppo import SMERL_PPO
...
if __name__ == '__main__':
    config = {
        ...
        'device': 'cuda',
        'result_path': '/home/xukang/Project/state_filtration_for_qd/results_for_smerl_ppo/'
    }
    for env in [
        #'Hopper',
        #'Walker',
        ...
        for seed in [10, 20, 30, 40, 50]:
            ...
            config['return_default'] = ret_default
            config['seed'] = seed
            main(config, '')
