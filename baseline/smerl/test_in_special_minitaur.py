...
if __name__ == "__main__":
    for seed in [10, 20, 30, 40, 50]:
        test_in_actual_model(   
            path= f'/home/xukang/Project/state_filtration_for_qd/results_for_smerl_ppo/Minitaur-{seed}/',
            remark='best',
            csv_path=f'/home/xukang/Project/state_filtration_for_qd/statistic/smerl_ppo/Minitaur_actual-{seed}.csv'
        )
        test_in_noisy_obs(   
            path= f'/home/xukang/Project/state_filtration_for_qd/results_for_smerl_ppo/Minitaur-{seed}/',
            remark='best',
            csv_path=f'/home/xukang/Project/state_filtration_for_qd/statistic/smerl_ppo/Minitaur_noise-{seed}.csv'
        )