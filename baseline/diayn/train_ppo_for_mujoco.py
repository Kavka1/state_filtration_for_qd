...
from state_filtration_for_qd.baseline.diayn.agent_ppo import DIAYN_PPO as DIAYN
...
if __name__ == '__main__':
    ...
    demo('/home/xukang/Project/state_filtration_for_qd/results_for_diayn/ppo-r_ex-Hopper-10/','best')