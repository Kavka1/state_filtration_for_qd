    ...
    for env in [
        ...
        for seed in [
            ...
            for leg_foot in [[0,1], [1,0]]:
                if leg_foot == [0,1]:
                    csv_mark = 'leg'#'right_leg'#'hip'#'leg'
                else:
                    csv_mark = 'foot'#'right_foot'#'ankle'#'foot'
                ...
                main(   
                    ...
                    csv_path=f'/home/xukang/Project/state_filtration_for_qd/statistic/multi/{env}_broken_{csv_mark}-{seed}.csv'
                )