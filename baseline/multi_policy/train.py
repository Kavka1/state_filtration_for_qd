...
from state_filtration_for_qd.baseline.multi_policy.ensemble_ppo import MultiPolicy_PPO
...
if __name__ == '__main__':
    config = {
        ...
        'device': 'cuda',
        'result_path': '/home/xukang/Project/state_filtration_for_qd/results_for_multi_policy/'
    }
    for env in [
        #'Hopper',
        'Walker',
