...
class MinitaurBulletEnv(gym.Env):
    ...
    def __init__(
      ...
      episode_length=2000,
        ...
        self.initial_coeff_value = [
        self.minitaur.GetBaseMassFromURDF(),
        self.minitaur.GetLegMassesFromURDF(),
            MOTOR_VOLTAGE,
    ...
    def _termination(self):
        ...
        return self.is_fallen() or distance > self._distance_limit or self._env_step_counter >= self.episode_length
